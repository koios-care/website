    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10 max-w-3xl">
        <div className="prose prose-lg">
          ...
          <p>Koios Care is a health technology company revolutionizing the management of Parkinson's Disease and other neurological disorders. Its AI-powered platform, passively collects data from everyday smartphones and smartwatches to provide continuous, clinically meaningful insights into patients' daily functioning and related quality of life. Koios Care empowers patients, providers, and pharmaceutical companies with objective, real-world data to improve outcomes, enhance care efficiency, and accelerate therapeutic innovation. Existing investors in Koios Care include <a href="https://www.lumiares.com/" target="_blank" rel="noopener noreferrer" className="text-bubbly-pink underline">Lumiares</a>, <a href="https://www.imecistart.com/en" target="_blank" rel="noopener noreferrer" className="text-bubbly-pink underline">imec.istart</a> and BlueHealth innovation Fund.</p>
