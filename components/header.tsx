              ...
              {navigationLinks.map((item, index) => (
                item.children ? (
                  ...
                  <button
                    ...
                    type="button"
                    className="px-4 py-2 bg-warm-purple text-white rounded-full hover:bg-bubbly-pink transition-colors body-style"
                  >
                    {item.label}
                  </button>
                ) : item.href ? (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="text-warm-purple hover:text-bubbly-pink transition-colors body-style"
                  >
                    {item.label}
                  </Link>
                ) : null
