      ...
      <div className="w-full px-4 md:container md:mx-auto md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 w-full">
          {solutions.map((solution, index) => (
            ...
            >
              {solution.isContactForm ? (
                <div className="block h-full">
                  <div 
                    onClick={() => setIsContactFormOpen(true)}
                    className="cursor-pointer flex flex-col h-full p-4 md:p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-bubbly-pink/20"
                  >
